let debug,createClient,stripAnsi,format,errorSerializer;_a82‍.x([["createLogger",()=>createLogger]]);_a82‍.w("debug",[["default",["debug"],function(v){debug=v}]]);_a82‍.w("node-loggly-bulk/lib/loggly/client",[["createClient",["createClient"],function(v){createClient=v}]]);_a82‍.w("strip-ansi",[["default",["stripAnsi"],function(v){stripAnsi=v}]]);_a82‍.w("util",[["format",["format"],function(v){format=v}]]);_a82‍.w("./logSerializers",[["errorSerializer",["errorSerializer"],function(v){errorSerializer=v}]]);/* eslint-disable no-console */
...
const handleRejection = (reason) => _a82‍.g.console.error('Unhandled promise rejection:', reason);
...
const logVerbose = (type, args) => {
  ...
  const log = (type) => (...args) => {
    ...
    else _a82‍.g.console[type](...messages);
