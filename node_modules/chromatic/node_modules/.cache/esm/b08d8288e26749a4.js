let chalk,dedent,error,info,link;_e26‍.x([["default",()=>_e26‍.o]]);_e26‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_e26‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_e26‍.w("../../components/icons",[["error",["error"],function(v){error=v}],["info",["info"],function(v){info=v}]]);_e26‍.w("../../components/link",[["default",["link"],function(v){link=v}]]);
...
const _e26‍anonymous=(isGithubAction) =>
  dedent(chalk`
