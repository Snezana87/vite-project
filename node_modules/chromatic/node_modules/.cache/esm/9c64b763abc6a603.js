let path,execa,gql,EOL,gitNoCommits,gitNotInitialized,gitNotInstalled;_abc‍.x([["FETCH_N_INITIAL_BUILD_COMMITS",()=>FETCH_N_INITIAL_BUILD_COMMITS],["getVersion",()=>getVersion],["getSlug",()=>getSlug],["getCommit",()=>getCommit],["getBranch",()=>getBranch],["hasPreviousCommit",()=>hasPreviousCommit],["getParentCommits",()=>getParentCommits],["getBaselineBuilds",()=>getBaselineBuilds],["getChangedFiles",()=>getChangedFiles],["isUpToDate",()=>isUpToDate],["isClean",()=>isClean],["getUpdateMessage",()=>getUpdateMessage],["findMergeBase",()=>findMergeBase],["checkout",()=>checkout],["checkoutPrevious",()=>checkoutPrevious],["discardChanges",()=>discardChanges],["getWorkingDir",()=>getWorkingDir]]);_abc‍.w("path",[["default",["path"],function(v){path=v}]]);_abc‍.w("execa",[["default",["execa"],function(v){execa=v}]]);_abc‍.w("fake-tag",[["default",["gql"],function(v){gql=v}]]);_abc‍.w("os",[["EOL",["EOL"],function(v){EOL=v}]]);_abc‍.w("../ui/messages/errors/gitNoCommits",[["default",["gitNoCommits"],function(v){gitNoCommits=v}]]);_abc‍.w("../ui/messages/errors/gitNotInitialized",[["default",["gitNotInitialized"],function(v){gitNotInitialized=v}]]);_abc‍.w("../ui/messages/errors/gitNotInstalled",[["default",["gitNotInstalled"],function(v){gitNotInstalled=v}]]);
