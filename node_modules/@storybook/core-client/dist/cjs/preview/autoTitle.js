...
exports.autoTitle = exports.autoTitleFromEntry = void 0;
...
var _global$FEATURES = _global.default.FEATURES,
    ...
    _global$STORIES = _global.default.STORIES,
...
var autoTitleFromEntry = function autoTitleFromEntry(fileName, entry) {
  ...
  var normalizedDirectory = directory && (0, _slash.default)(directory);
  var normalizedFileName = (0, _slash.default)(fileName);

  if (normalizedFileName.startsWith(normalizedDirectory)) {
    var suffix = normalizedFileName.replace(normalizedDirectory, '');
...
exports.autoTitleFromEntry = autoTitleFromEntry;
...
var autoTitle = FEATURES.previewCsfV3 ? autoTitleV3 : autoTitleV2;
